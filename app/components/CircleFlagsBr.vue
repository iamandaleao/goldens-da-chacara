<template>
  <svg
    ...
    height="1em"
    viewBox="0 0 512 512"
  ><!-- Icon from Circle Flags by HatScripts - https://github.com/HatScripts/circle-flags/blob/gh-pages/LICENSE --><mask id="SVGuywqVbel"><circle
    cx="256"
    cy="256"
    r="256"
    fill="#fff"
  /></mask><g mask="url(#SVGuywqVbel)"><path
    fill="#6da544"
    d="M0 0h512v512H0z"
  /><path
    fill="#ffda44"

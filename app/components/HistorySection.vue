    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        <div class="bg-amber-100 rounded-2xl p-6 sm:p-8">
          <h4 class="text-lg sm:text-xl font-bold text-gray-900 mb-4 sm:mb-6">
            Nossa Timeline
          </h4>
          <div class="space-y-4">
            <div class="flex items-start gap-3">
              <div class="w-3 h-3 bg-amber-600 rounded-full mt-1.5 flex-shrink-0" />
              <div>
            ...
            <div class="flex items-start gap-3">
              <div class="w-3 h-3 bg-gray-300 rounded-full mt-1.5 flex-shrink-0" />
              <div>
                <p class="font-semibold text-gray-900 text-sm sm:text-base">
                  Próximos Meses
                </p>
                <p class="text-gray-600 text-xs sm:text-sm">
                  Preparação completa do ambiente e estrutura
                </p>
              </div>
            </div>
            <div class="flex items-start gap-3">
